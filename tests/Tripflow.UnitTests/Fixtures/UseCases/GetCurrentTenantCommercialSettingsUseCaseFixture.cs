...
public class GetCurrentTenantCommercialSettingsUseCaseFixture : IDisposable
{
    ...
    public GetCurrentTenantCommercialSettingsUseCase UseCase { get; private set; } = null!;

    public Guid CurrentTenantId { get; private set; } = Guid.NewGuid();

    public GetCurrentTenantCommercialSettingsUseCaseFixture()
    {
    ...
    private void ResetMocks()
    {
        ...
        UseCase = new GetCurrentTenantCommercialSettingsUseCase(
            MockRepository.Object,
            MockUserContext.Object,
            MockTenantContext.Object,
            MockUserPermissionService.Object,
            Mapper,
            NullLogger<GetCurrentTenantCommercialSettingsUseCase>.Instance);
    }

    public GetCurrentTenantCommercialSettingsUseCase CreateForSuccess(TenantCommercialSettings? settings = null)
    {
        ResetMocks();
        var entity = settings ?? TenantCommercialSettingsTestHelper.CreateWithCommercialData(tenantId: CurrentTenantId);
        MockRepository
    ...
    public GetCurrentTenantCommercialSettingsUseCase CreateForEmpty()
    {
        ResetMocks();
        MockRepository
    ...
    public GetCurrentTenantCommercialSettingsUseCase CreateForUnauthenticated()
    {
        ResetMocks();
    ...
    public GetCurrentTenantCommercialSettingsUseCase CreateForNoTenant()
    {
        ResetMocks();
    ...
    public GetCurrentTenantCommercialSettingsUseCase CreateForNoPermission()
    {
        ResetMocks();
        MockUserPermissionService
            .Setup(s => s.HasPermissionAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
    ...
    public GetCurrentTenantCommercialSettingsUseCase CreateForRepositoryError()
    {
        ResetMocks();
        MockRepository
            .Setup(r => r.GetByTenantIdAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
