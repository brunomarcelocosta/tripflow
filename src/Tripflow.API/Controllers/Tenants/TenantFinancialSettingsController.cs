...
[ApiController]
[Route("api/tenant-financial-settings")]
[Authorize]
public sealed class TenantFinancialSettingsController(
    IGetCurrentTenantFinancialSettingsUseCase getCurrentUseCase,
    IUpdateTenantFinancialSettingsUseCase updateUseCase) : ControllerBase
{
    [HttpGet("current")]
    ...
    public async Task<IActionResult> UpdateCurrent(
        [FromBody] UpdateTenantFinancialSettingsRequest request,
