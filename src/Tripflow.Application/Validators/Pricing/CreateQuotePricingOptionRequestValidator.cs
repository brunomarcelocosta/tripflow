...
public sealed class CreateQuotePricingOptionRequestValidator : AbstractValidator<CreateQuotePricingOptionRequest>
{
    public CreateQuotePricingOptionRequestValidator()
    {
