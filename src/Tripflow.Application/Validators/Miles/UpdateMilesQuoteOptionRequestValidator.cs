...
public sealed class UpdateMilesQuoteOptionRequestValidator : AbstractValidator<UpdateMilesQuoteOptionRequest>
{
    public UpdateMilesQuoteOptionRequestValidator()
    {
